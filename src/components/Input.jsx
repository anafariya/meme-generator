...
function Input() {
  const [memeUrl, setMemeUrl] = useState(""); // Initialize state for memeUrl

  const generateMeme = () => {
    const memeIndex = Math.floor(Math.random() * 100);
    const newMemeUrl = memes[memeIndex].url;
  ...
  return (
    <>
      <div className="flex items-center justify-between p-8 bg-white rounded-lg shadow-md">
        <div className="flex flex-col w-1/2">
          <input
            ...
            className="mb-4 text-lg border border-rose-500 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <input
            type="text"
            placeholder="Bottom text"
            className="text-lg border border-rose-500 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
        <button
      ...
      <div className="flex items-center justify-center h-100">
        <div className="w-100 ">
          {" "}
          <img src={memeUrl} alt="" className="h-80" />
        </div>
      </div>
    </>
  );
